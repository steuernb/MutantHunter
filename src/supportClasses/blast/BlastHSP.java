...
public class BlastHSP implements Comparable<BlastHSP> {
    ...
    */
	...
	/*
	public BlastHSP(String hsp){
		String[] split = hsp.split("\t");
		
		queryName =split[0];
		queryDescription =  split[1];
		hitName = split[6];                              
		hitDescription = split[7];                   
		                                  
		               
		                                  
		                                  
		rawScore = Double.parseDouble(split[11]);                            
		bitScore =Double.parseDouble( split[15]);                         
		                                  
		queryLength =Integer.parseInt( split[2]);                         
		hitLength = Integer.parseInt(split[8]);  
		
		hspLength = Integer.parseInt(split[21]);                           
		                                    
		evalue = split[10];                          
		                                     
		queryStart = Integer.parseInt(split[25]);                          
		hitStart = Integer.parseInt(split[24]);              
		queryEnd = Integer.parseInt(split[27]);                            
		hitEnd = Integer.parseInt( split[26]);                          
		                                     
		hspRank = Integer.parseInt(split[17]);                             
		...
		numGaps = Integer.parseInt(split[14]); 
		
		hitStrand = Integer.parseInt(split[30]);                           
		queryStrand = Integer.parseInt(split[31]);    
		numIdentical = Integer.parseInt(split[12]);
		                                     
		queryString = split[18];                      
		hitString = split[20];                        
	}
*/	
